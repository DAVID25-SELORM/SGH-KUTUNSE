...
export const smsTemplates = [
  { id: "patient_feedback", name: "Patient Feedback", purpose: "feedback_request" as const, message: "Thank you for visiting Satellite General Hospital. We value your experience. Please take 2 minutes to share your feedback with us: [SURVEY LINK]" },
