...
export const smsTemplates = [
  { id: "patient_feedback", name: "Patient Feedback", purpose: "feedback_request" as const, message: "Thank you for choosing Satellite General Hospital. Please take a moment to share your experience with us: [SURVEY LINK]" },
